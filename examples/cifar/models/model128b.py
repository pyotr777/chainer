...
class model128b(chainer.Chain):
    ...
    def __init__(self, class_labels=10):
        super(model128b, self).__init__()
        with self.init_scope():
            self.block64_1 = Block(64, 3)
            self.block64_2 = Block(64, 3)
            self.block64_3 = Block(64, 3)
            self.block128_1 = Block(128, 3)
            self.block128_2 = Block(128, 3)
